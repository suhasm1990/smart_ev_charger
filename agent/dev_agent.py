...
DEV_SYSTEM_INSTRUCTION = (
    ...
    "   c. Create a git branch, commit, push, and open a PR using 'dev_run_command':\n"
    ...
    "   d. Respond with the GitHub Pull Request URL and a summary of what was changed.\n"
...
def run_dev_agent_loop(task_description: str, pr_number: int = None) -> str:
    ...
    if pr_number:
        ...
        user_prompt = (
            ...
            f"{task_description}\n\n"
            f"1. Inspect the relevant files using dev_read_file or dev_search_code.\n"
            f"2. If a code fix is needed: apply changes, run tests, commit to a new branch, push to origin, and open a Pull Request using 'gh pr create'.\n"
            f"3. If no code changes are required: provide a clear explanation of your findings."
        )
